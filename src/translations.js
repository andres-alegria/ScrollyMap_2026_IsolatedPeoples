const translations = {
  es: {
    ...
    "Using the Earth Index, an AI algorithm, Mongabay detected 76 clandestine landing strips hidden in the Peruvian Amazon.":
      "Mongabay y Earth Genome detectaron 67 pistas de aterrizaje clandestinas utilizadas para el transporte de droga en las regiones peruanas de Ucayali, Huánuco y Pasco.",
    "Published": "Publicado",
    ...
    "Earth Index, an artificial intelligence algorithm, detected 76 clandestine landing strips hidden in the Peruvian Amazon.":
      "Earth Index, un algoritmo de inteligencia artificial, detectó 76 pistas de aterrizaje clandestinas ocultas en la selva peruana.",
    ...
    "National Police of Peru's Anti-Narcotics Unit (Dirandro), Earth Genome, OpenStreetMap, and Ucayali Regional Government.":
      "Dirandro, Gore Ucayali, Earth Genome y OpenStreetMap.",
    ...
    "Journalistic verification of each airstrip involved cross referencing results from Earth Index with government data, open source information and local sources. This investigation confirms that 67 of the 76 drug runways are distributed between Ucayali (45), Huánuco (17) and Pasco (5), and today serve drug trafficking.":
      "La verificación periodística de cada una de ellas, con fuentes oficiales y locales, fue clave para confirmar que 67 de las 76 narcopistas están distribuidas entre Ucayali (45), Huánuco (17) y Pasco (5), y sirven hoy al narcotráfico.",
    "Coca crop density in 2023": "Densidad del cultivo de coca",
    "Peru's National Commission for Development and Life without Drugs (DEVIDA)":
      "Comisión Nacional para el Desarrollo y Vida sin Drogas (DEVIDA)",
    "Beseiging Indigenous territories": "Asediando territorios indígenas",
    ...
    "Illegal airstrips have taken over entire landscapes in this corner of the Amazon Rainforest. In the province of Atalaya, which is part of the Ucayali region, we detected 32 airstrips.":
      "Algunos de los tajos abiertos en ese triángulo de ilegalidad han tomado paisajes completos. Sólo en la provincia de Atalaya, en la región Ucayali, se detectaron 32 pistas.",
    "Tree Cover Loss": "Deforestación",
    "Crucially, 30 of the 67 narco airstrips were detected within Indigenous territories and 26 more are located near them.":
      "Lo crítico es que 30 de las 67 narcopistas detectadas por el algoritmo están dentro de territorios indígenas y 26 alrededor.",
    ...
    "Following up on the satellite imagery analysis, Mongabay Latam journalists reached two communities, located between the regions of Huánuco and Pasco with 15 clandestine landing strips in their territories.":
      "Siguiendo la información satelital, periodistas de Mongabay Latam llegaron a dos comunidades, ubicadas entre las regiones de Huánuco y Pasco, que soportan juntas la presencia de 15 pistas de aterrizaje clandestinas en sus territorios.",
    ...
    "Narco airstrips are present in nine forestry concessions, which are zoned for sustainable forest use. The Earth Index identified ten airstrips within these kinds of concessions.":
      "Las narcopistas se han instalado incluso dentro de 9 concesiones forestales que están destinadas al aprovechamiento sostenible del bosque. El algoritmo detectó en total 10 trazos.",
